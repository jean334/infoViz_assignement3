...
import Hive from "../Components/Hive_as3";
...
function Home() {
    return(
      ...
      <div className="bar-race-viz">
        <VizContainer viz={Hive} title={"Number of Monthly Social Media Active Users in Millions"} groups={GroupsHive} text={BarRaceText} hasSidePanel={false}/>
      </div>
